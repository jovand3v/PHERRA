...
const CollectionProductInfo = (props: Props) => {
  ...
  return (
    <div className={`${s.main} ${selectedProduct ? s.active : ""}`}>
      {selectedProduct && (
        <>
              ...
              <div className={s.buttonContainer}>
                <div className={s.priceContainer}>
                  <div className={s.oldPriceContainer}>
                    <span className={s.oldPrice}>$159</span>
                    <span className={s.discount}>-19%</span>
                  </div>
                  <p className={s.price}>$129.99</p>
                </div>
